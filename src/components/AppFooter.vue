    ...
    <footer>
        <div class="ss-footer">
            <div class="row">
                <div class="col-md-4">
                    <h3>고객센터</h3>
                    <p><b>1588-1588</b> 09:00 ~ 18:00</p>
                    <p>평일: 전체 문의 상담</p>
                    <p>토요일, 공휴일: 이사/제품설치 문의 상담</p>
                    <p>일요일: 휴무</p>
                    <p>카톡 상담(평일 09:00~18:00)</p>
                    <p>이메일 문의</p>
                </div>
                <div class="col-md-2">
                    <p>회사소개</p>
